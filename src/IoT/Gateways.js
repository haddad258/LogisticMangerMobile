...
export default class Gateways extends Component {
  ...
  Displaylist() {
    AsyncStorage.getItem('@storage_Key').then((data) => {
      ...
      axios.get("http://dev.hivetracker.io/api/mobile/gateways/index", config)
        .then(response => {
        ...
        <View key={item.id} style={styles.row}>
          <View>
            <View style={styles.nameContainer}>
              ...
              <Text style={styles.mblTxt} numberOfLines={1} ellipsizeMode="tail">show gateways</Text>
      ...
      <View style={{ flex: 1 }} >
        ...
        <View style={{ flexDirection: "row", marginLeft: 20, marginRight: 20 }}>
          <TouchableOpacity style={[styles.buttonContainer, styles.sendButton]} onPress={() => this.Displaylist()}>
            <Text style={styles.buttonText}>all gateways</Text>
          </TouchableOpacity>

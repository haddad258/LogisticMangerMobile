...
export default class pallets extends Component {
  ...
  Displaylist() {
    AsyncStorage.getItem('@storage_Key').then((data) => {
      ...
      axios.get("http://dev.hivetracker.io/api/mobile/pallets/index", config)
        .then(response => {
      ...
      <View style={{ flex: 1 }} >
        ...
        <View style={{ flexDirection: "row", marginLeft: 20, marginRight: 20 }}>
          <TouchableOpacity style={[styles.buttonContainer, styles.sendButton]} onPress={() => this.Displaylist()}>
            <Text style={styles.buttonText}>all pallets</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.buttonContainer, styles.sendButton]} onPress={() => this.props.navigation.navigate("Camera",{entity:"Pallets"})}>
